...
- CRUCIAL JD KEYWORDS FIRST (do not miss any): before listing, extract the JD's CRUCIAL keywords — every required or repeated hard skill, framework, tool, platform, language, methodology, and certification, plus the core terms of the exact job title. EVERY crucial keyword the candidate genuinely has or is closely transferable to MUST appear in this list, verbatim in the JD's wording, placed ahead of generic skills. Scan the WHOLE job description, including requirements listed near the end. If the item limit is reached, drop generic or non JD skills first; NEVER drop a crucial JD keyword the candidate genuinely has.
